package com.cucutain.staffspartans.Common;
...
public class Common {
    ...
    public static final String MONEY_SION = "$ ";
    ...
    public static void updateToken(Context context, String token) {
        ...
        if (user!=null)
        {
            ...
            myToken.setUserPhone(user.getDisplayName());
            ...
            Paper.init(context);
            String username = Paper.book().read(Common.LOGGED_KEY);
            if (username != null) {
                if (!TextUtils.isEmpty(username)) {
                    MyToken myToken = new MyToken();
                    myToken.setToken(token);
                    myToken.setTokenType(TOKEN_TYPE.BARBER);
                    myToken.setUserPhone(username);
