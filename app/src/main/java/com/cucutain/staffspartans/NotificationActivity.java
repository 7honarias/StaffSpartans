...
import com.cucutain.staffspartans.Adapter.MyNotificationAdapter;
import com.cucutain.staffspartans.Common.Common;
import com.cucutain.staffspartans.Interface.INotificationLoadListener;
...
public class NotificationActivity extends AppCompatActivity implements INotificationLoadListener {
    ...
    private void loadNotification(DocumentSnapshot lastDoc) {
        ...
        if (lastDoc == null)
        {
            notificationCollection.orderBy("serverTimestap", Query.Direction.DESCENDING)
                ...
                public void onComplete(@NonNull Task<QuerySnapshot> task) {
                    if (task.isSuccessful()){
                        ...
                        iNotificationLoadListener.onNotificationLoadSuccess(myNotificationList,finalDoc);
                    }
