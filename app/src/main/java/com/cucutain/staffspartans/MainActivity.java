...
import com.cucutain.staffspartans.Adapter.MyStateAdapter;
import com.cucutain.staffspartans.Common.Common;
import com.cucutain.staffspartans.Common.SpacesItemDecoration;
import com.cucutain.staffspartans.Interface.IOnAllStateLoadListener;
...
public class MainActivity extends AppCompatActivity implements IOnAllStateLoadListener {
            ...
            public void onPermissionsChecked(MultiplePermissionsReport report) {
                ...
                if (TextUtils.isEmpty(user))
                {
                    ...
                    Common.selected_salon = gson.fromJson(Paper.book().read(Common.SALON_KEY,""),
                            new com.google.gson.reflect.TypeToken<Salon>(){}.getType());
    ...
    private void init() {
        allSalonCollection = FirebaseFirestore.getInstance().collection("Restaurants");
