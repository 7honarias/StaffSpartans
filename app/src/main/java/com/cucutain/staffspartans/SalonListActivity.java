...
import com.cucutain.staffspartans.Adapter.MySalonAdapter;
import com.cucutain.staffspartans.Common.Common;
import com.cucutain.staffspartans.Common.SpacesItemDecoration;
import com.cucutain.staffspartans.Interface.IBranchLoadListener;
import com.cucutain.staffspartans.Interface.IGetBarberListener;
import com.cucutain.staffspartans.Interface.IOnLoadCountSalon;
...
public class SalonListActivity extends AppCompatActivity implements IOnLoadCountSalon, IBranchLoadListener, IGetBarberListener, IUserLoginRememberListener {
    ...
    @Override
    public void onBranchLoadSuccess(List<Salon> brachList) {
        MySalonAdapter salonAdapter = new MySalonAdapter(this,brachList,this,this);
